    ...
    return (
        <div className="py-20" id="testimonials">
            <h1 className="heading">
                İş
                <span className="text-purple"> Tecrübem</span>
            </h1>
            <div className="mt-12 grid w-full grid-cols-1 gap-10 lg:grid-cols-4">
                {workExperience.map((card) => (
                    <Button key={card.id} duration={Math.floor(Math.random() * 10000) + 10000} borderRadius="1.75m" className="flex-1 border-neutral-200 text-white dark:border-slate-800">
