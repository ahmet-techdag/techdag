...
export function Button({
    ...
    return (
        <Component
            className={cn(
                "relative overflow-hidden md:col-span-2", containerClassName)}
            style={{
        ...
        >
            <div className="absolute inset-0" style={{ borderRadius: `calc(${borderRadius} * 0.96)` }}>
                <MovingBorder duration={duration} rx="30%" ry="30%">
                    <div className={cn("h-20 w-20 bg-[radial-gradient(var(--sky-500)_40%,transparent_60%)] opacity-[0.8]", borderClassName)} />
                </MovingBorder>
            </div>
