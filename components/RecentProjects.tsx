    ...
    return (
        <div className="py-20">
            <h1 className="heading">
                Son projelerden <span className="text-purple">küçük seçimler</span>
            </h1>
                    ...
                    <div className="flex h-[25rem] w-[80vw] items-center justify-center sm:w-96 lg:min-h-[32.5rem]" key={item.id}>
                        <PinContainer title="/ui.aceternity.com" href="https://twitter.com/mannupaaji">
                            <div className="relative mb-10 flex h-[20vh] w-[80vw] items-center justify-center overflow-hidden sm:w-96 lg:h-[30vh]">
                                <div className="relative h-full w-full overflow-hidden lg:rounded-3xl" style={{ backgroundColor: "#13162D" }}>
                            ...
                            <div className="mb-3 mt-7 flex items-center justify-between">
                                ...
                                <div className="flex items-center justify-center">
                                    <p className="flex text-sm text-purple md:text-xs lg:text-xl">SİTEYE GİT</p>
